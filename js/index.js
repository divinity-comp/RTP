...
function loadInJobsStandardUser(jobData) {
    ...
    for(i = 0; i < jobData["jobData"].length;i++) {
        ...
        var dataToAdd = '<figure>                <img src="https://rtp-app.divinitycomputing.com/v1/assets/client/rtp-logo.jpg">
            </figure><div onclick="openJob(' + jobData["jobData"][i].jobid + ');" class="title">';
